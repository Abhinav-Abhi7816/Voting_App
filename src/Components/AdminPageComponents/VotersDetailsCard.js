    ...
    <div>
      <div className='bg-[rgb(0,0,0,0.2)] md:p-8 p-4 rounded-lg '>
            <section className="text-gray-600 body-font ">
                <div className="bg-[#d8ebf2] container mx-auto flex md:px-16 px-8 md:py-10 py-4 md:flex-col flex-col rounded-lg " style={{boxShadow:"0px 0px 20px rgb(0,0,0,0.3)"}}>
                    <div className="flex flex-col md:text-xl text-sm gap-3 min-w-[200px]  md:min-w-[250px]">
                        ...
                        <p className='text-wrap text-lg'>email : {voterDetailsObj.email}</p>
                        {
